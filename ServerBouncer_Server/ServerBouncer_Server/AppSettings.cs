...
namespace ServerBouncer_Server
{
    static class AppSettings
    {
        ...
        public static IReadOnlyList<float> PostStopDelaysInMilliseconds { get; private set; }
        public static IReadOnlyList<float> PostStartDelaysInMilliseconds { get; private set; }
